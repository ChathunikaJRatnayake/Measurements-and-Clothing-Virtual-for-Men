...
% Last Modified by GUIDE v2.5 20-Sep-2016 11:36:23
...
%        str2double(get(hObject,'String')) returns contents of userId as a double
...
function userPassword_Callback(hObject, eventdata, handles)
% hObject    handle to userPassword (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of userPassword as text
%        str2double(get(hObject,'String')) returns contents of userPassword as a double


% --- Executes during object creation, after setting all properties.
function userPassword_CreateFcn(hObject, eventdata, handles)
% hObject    handle to userPassword (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in btnLogin.
function btnLogin_Callback(hObject, eventdata, handles)
% hObject    handle to btnLogin (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
userID = get(handles.userId,'String');
userPass = get(handles.userPassword,'String');

 if isempty (userID) || isempty(userPass)
     msgbox('Please Enter the ID & Password','warning','warn');
 elseif strcmp(userID,'dilhan') && strcmp(userPass,'****')
     run('Customer_page.m');
     hf = findobj('Name','Login');
     close(hf);
 else
     msgbox('Please Try Again','warning','warn');
 end
